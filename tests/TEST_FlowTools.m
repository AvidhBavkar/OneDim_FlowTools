...
reset();
%% ~~~~~~~~~~ISENTROPIC TOOL:~~~~~~~~~~
%% Test tratio_from_pratio:
%TRUTH SOURCE: https://devenport.aoe.vt.edu/aoe3114/calc.html
gamma = 1.4;
truth_tratio = 1./0.82033535;
p_ratio = 1./0.5;
test_tools.validate("tratio_from_pratio",...
    IsentropicFlow_Tools.tratio_from_pratio(gamma, p_ratio),...
    truth_tratio,...
    0.01,...
    show_successful_values);

reset();
%% Test pratio_from_tratio:
%TRUTH SOURCE: https://devenport.aoe.vt.edu/aoe3114/calc.html
gamma = 1.4;
truth_pratio = 1./0.5;
t_ratio = 1./0.82033535;
test_tools.validate("pratio_from_tratio supersonic",...
    IsentropicFlow_Tools.pratio_from_tratio(gamma, t_ratio),...
    truth_pratio,...
    0.01,...
    show_successful_values);
...
%% Test mach_FROM_totstat_tratio:
%TRUTH SOURCE: https://devenport.aoe.vt.edu/aoe3114/calc.html
gamma = 1.4;
tot_stat_tratio = 1./0.44;
truth_mach = 2.52262489;
test_tools.validate("mach_FROM_totstat_tratio",...
    IsentropicFlow_Tools.mach_FROM_totstat_tratio(gamma, tot_stat_tratio),...
    truth_mach,...
    0.01,...
    show_successful_values);
